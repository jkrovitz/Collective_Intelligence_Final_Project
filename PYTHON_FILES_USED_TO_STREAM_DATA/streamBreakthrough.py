...
twitterStream.filter(track=["Breakthrough", "BreakthroughMovie", "#BreakthroughMovie", "SeeBreakthrough", "BreakthroughTickets.com", "BREAKTHROUGH", "BREAKTHROUGHMOVIE"], languages=["en"])
